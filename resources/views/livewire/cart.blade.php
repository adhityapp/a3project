                    ...
                    @forelse($products as $product)
                        <div class="col-md-3 mb-3" :key="{{$product->id}}">
                            <div class="card" >
                                ...
                                <a data-toggle="modal" data-target="#detilproduk">
                                    <button class ="btn btn-success d-inline btn-sm btn-block">Details</button>
                                </a>
                            </div>
                        </div>
                        <div class="modal fade" id="detilproduk" tabindex="-1" role="dialog" style="z-index:1050; display: none" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group col">
                                            ...
                                            <div class="row">
                                                ...
                                                @if($product->image)
                                                    <img src="{{ asset('storage/images/'.$product->image)}}" class="img-fluid" id="preview">
                                                @endif
                                            </div>
                                            <div class="row">
                                                <label for="Description" class="col-sm-4 control-label">Description: </label>
                                                <span class="font-weight-bolder">{{$product->description}}</span>
                                            </div>
                                            <div class="row">
                                                <label for="Qty" class="col-sm-4 control-label">Qty: </label>
                                                <span class="font-weight-bolder">{{$product->qty}}</span>
                                            </div>
                                            <div class="row">
                                                <label for="Harga" class="col-sm-4 control-label">Harga: </label>
                                                <span class="font-weight-bolder">{{$product->price}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="icofont icofont-eye-alt">close</i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
